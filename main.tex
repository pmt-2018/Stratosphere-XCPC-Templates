...
\begin{itemize}
    ...
    \item 有源汇上下界最大流：从 $T$ 到 $S$ 连一条下界为 $0$，上界为 $+\infty$ 的边，转化为无源汇网络。按照**无源汇上下界可行流**的做法求一次无源汇上下界超级源$SS$到超级汇$TT$的最大流。
    删去所有附加边，在上一步的\textbf{残量网络}基础上，求一次 $S$ 到 $T$ 的最大流。两者之和即为答案。
    \item 有源汇上下界最小流：从 $T$ 到 $S$ 连一条下界为 $0$，上界为 $+\infty$ 的边，转化为无源汇网络。按照**无源汇上下界可行流**的做法求一次无源汇上下界超级源$SS$到超级汇$TT$的最大流。
